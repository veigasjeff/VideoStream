export default function TermsOfService() {
    return (
      <div className="max-w-4xl mx-auto p-6">
        ...
        <p className="text-gray-700 mb-4">
          - Do not upload copyrighted content without permission.<br />
          - No violent, hateful, explicit, or illegal content is allowed.<br />
          - Users may report inappropriate content, which may be reviewed and removed at our discretion.<br />
          - We reserve the right to remove videos without prior notice.
        </p>
        ...
        <p className="text-gray-700 mb-4">
          - Users may delete their accounts at any time.<br />
          - We reserve the right to suspend or terminate accounts violating our policies.<br />
        ...
        <p className="text-gray-700 mb-4">
          - These terms may be updated at any time, and continued use of the platform constitutes acceptance of the changes.<br />
          - Users will be notified of major changes to our terms.
        </p>
