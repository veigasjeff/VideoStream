...
//   adScript.setAttribute('data-zone', '92363');
//   adScript.async = true;
//   adScript.setAttribute('data-cfasync', 'false');
...
// setTimeout(loadAdCode, 10000); // 15000 milliseconds = 15 seconds
      ...
      // <script src="https://alwingulla.com/88/tag.min.js" data-zone="92363" async data-cfasync="false"></script>

      // Function to load the ad code
function loadAdCode() {
  var adScript = document.createElement('script');
  adScript.src = '//thubanoa.com/1?z=7993731';
  adScript.async = true;
  adScript.setAttribute('data-cfasync', 'false');
...
{/* <script async="async" data-cfasync="false" src="//thubanoa.com/1?z=7993731"></script> */}